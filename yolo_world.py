...
CLASSES = ["person", "traffic light", "stop sign"]

while len(CLASSES) < 80:
    CLASSES.append("")
...
class YOLOWORLD():
    ...
    def run(self):
        ...
        if args.save_text_outputs:
            np.save('coco_text_outp.npy', text_outputs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--text_model', type=str, help="clip_text model path", default='clip_text.rknn')
    parser.add_argument('--yolo_world', type=str, help="yolo_world model path", default='yolo_world_v2s.rknn')
    parser.add_argument('--target', type=str, help="target platform", default="rk3588")
    parser.add_argument('--img', type=str, help="input image", default='image.png')
